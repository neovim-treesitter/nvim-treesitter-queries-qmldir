# nvim-treesitter-queries-qmldir

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-qmldir/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-qmldir/actions/workflows/validate.yml)

Neovim tree-sitter queries for **qmldir**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-qmldir",
...
- [ ] Changes are scoped to `qmldir` — do not include files for other languages
